...
trait GeneralTrait
{
    ...
    public function loginRespones($user , $token){
        return response()->json([
            'status' => 'success',
            'user' => $user,
            'authorisation' => [
    ...
    public function likeResponse($reels_id){
        return response()->json([
            'status' => 'true',
            'msg' => 'Liked',
    ...
    public function regsterResponse($user , $token){
        return response()->json([
            'status' => 'success',
    ...
    public function refreshTheToken($token){
        return response()->json([
            'stutas' => true,
            'msg' => 'Bearer Token',
            'newToken'=>$token
    ...
    public function returnSuccessMessage($erorrNumber = '' , $msg = '')
    {
        return response()->json([
            'status' => 'success',
            'erorrNumber' => $erorrNumber,
            'msg' => $msg
        ]);
    }
    ...
    //////////////////
    public function returnValidationError($validator , $errorNumber = '')
    {
        return $this->returnError($errorNumber, $validator->errors()->first());
    }
    ...
    public function catchTheError($validation){
        $code = $this->returnCodeAccordingToInput(validator: $validation);
        return $this->returnValidationError(validator: $validation , errorNumber: $code);
    }
